...
## Demo
IT opens in Streamlite app
step1: enter your network interface card;
step2 :start your work on browser when ever you try to open any malicous web page it give an alert;
step3:Along with that it gives DNS TRAFFIC,PORT SCANNIG alerts
